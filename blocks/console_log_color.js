module.exports = {
    ...
    code(cache) {
        ...
        switch (Color) {
            case 1:
                result = (bgresult + "\x1b[30m" + content + "\x1b[37m\x1b[40m")
                break;
            case 2:
                result = (bgresult + "\x1b[31m" + content + "\x1b[37m\x1b[40m")
                break;
            case 3:
                result = (bgresult + "\x1b[32m" + content + "\x1b[37m\x1b[40m")
                break;
            case 4:
                result = (bgresult + "\x1b[33m" + content + "\x1b[37m\x1b[40m")
                break;
            case 5:
                result = (bgresult + "\x1b[34m" + content + "\x1b[37m\x1b[40m")
                break;
            case 6:
                result = (bgresult + "\x1b[35m" + content + "\x1b[37m\x1b[40m")
                break;
            case 7:
                result = (bgresult + "\x1b[36m" + content + "\x1b[37m\x1b[40m")
                break;
            case 8:
                result = (bgresult + "\x1b[37m" + content + "\x1b[37m\x1b[40m")
                break;
        }
